    ...
    <div class="wallet-shell">
        ...
        @if ($dailyCap > 0 || $totalCap > 0)
            <div class="wallet-card progress-card">
                <div class="history-header">
                    <div>
                        <h5><i class="fas fa-chart-line mr-2" style="color: {{ $barColor }};"></i>Wallet
                            Limits</h5>
                ...
                @if ($dailyCap > 0)
                    ...
                    <div class="progress-track mb-3">
                        <div class="progress-bar-fill"
                            style="width: {{ $dailyPct }}%; background: {{ $barColor }};"></div>
                    </div>
                @endif
                ...
                @if ($totalCap > 0)
                    ...
                    <div class="progress-track">
                        <div class="progress-bar-fill" style="width: {{ $totalPct }}%; background: #3498db;">
                        </div>
                    </div>
                @endif
            </div>
        ...
        <div class="actions-grid">
            ...
            <div class="wallet-card action-card" style="border-top:4px solid #6f42c1;">
                <div class="action-body">
                    ...
                    <p class="muted-note mt-2 mb-3">Repurchase wallet can be used for future product purchase or
                        plan upgrade.</p>
                ...
                <div class="action-footer">
                    <a href="{{ route('products') }}" class="btn btn-block"
                        style="background:#6f42c1;color:#fff;height:48px;border-radius:12px;font-weight:700;display:flex;align-items:center;justify-content:center;">
            ...
            <div class="wallet-card action-card" style="border-top:4px solid #ff6b35;">
                ...
                @if ($bankDetail)
                    <form method="POST" action="{{ route('member.wallet.withdraw') }}"
                        ...
                        <div class="action-body">
                            ...
                            <p class="muted-note mt-2 mb-2">Withdraw from your main wallet to the bank account
                                saved in your profile.</p>
                            ...
                            <div class="form-group">
                                <input type="number" name="amount" class="form-control"
                                    ...
                                    max="{{ $availableWithdrawalBalance }}" step="0.01"
                                    value="{{ old('amount') }}"
                        ...
                        <div class="action-footer">
                            <button type="submit" class="btn btn-block" style="background:#ff6b35;color:#fff;"
                ...
                @else
                    <div class="action-body">
                        <div class="card-kicker">Withdraw</div>
                        <h5><i class="fas fa-arrow-up text-warning mr-2"></i>Withdraw Funds</h5>
                        <p class="muted-note mt-2 mb-2">Withdraw from your main wallet to the bank account saved in
                            your profile.</p>
                    ...
                    <div class="action-footer">
                        <a href="{{ route('member.profile') }}" class="btn btn-block"
                            style="background:#ff6b35;color:#fff;height:48px;border-radius:12px;font-weight:700;display:flex;align-items:center;justify-content:center;">
        ...
        <div class="info-grid">
            ...
            <div class="wallet-card info-card">
                ...
                <p class="muted-note mb-0">Wallet transactions are protected and visible in your recent activity.
                </p>
            </div>
            ...
            <div class="wallet-card info-card">
                ...
                <h6>Need Help?</h6>
                <p class="muted-note mb-0">Support is available anytime for wallet, repurchase, and withdrawal
                    help.</p>
            </div>
        </div>
    </div>
